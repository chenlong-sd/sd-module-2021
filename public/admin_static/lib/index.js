...
layui.define(["setter","admin"],function(a){
 		...
 		l=function(a,e){
 			...
 			e=e||"新标签页",d||(u(s).append(['<div class="layadmin-tabsbody-item layui-show">','<iframe src="'+a+'" frameborder="0" class="layadmin-iframe"></iframe>',"</div>"].join("")),t.index=l.length,i.tabAdd(r,{title:"<span>"+e+"</span>",id:a,attr:o})),i.tabChange(r,a),n.tabsBodyChange(t.index,{url:a,text:e});u('#LAY_app_tabsheader>li:last-child').attr('draggable', 'true');},s="#LAY_app_body",r="layadmin-layout-tabs",u=layui.$;u(window);layui.config({base:e.base+"modules/"}),layui.each(e.extend,function(a,i){var n={};n[i]="{/}"+e.base+"lib/extend/"+i,layui.extend(n)}),d().autoRender(),a("index",{openTabsPage:l})});