...
class Ajax
{
    ...
    /**
     * 设置批量处理的字段名
     * @param string $batch_field 批量传输的字段
     * @return $this
     */
    public function setBatch(string $batch_field = 'id'): Ajax
    {
        $this->batch = $batch_field;
        return $this;
    }
...
JS;
            ...
            return $this->batch ? sprintf(' function batch_js(obj){%s} %s', $code, $this->batchData()) : $code;
        }
