<<<<<<< HEAD
/** 数据备份时间  2020-10-23 23:16:19 */
DROP TABLE `sd_administrators`;
DROP TABLE `sd_category`;
DROP TABLE `sd_log`;
DROP TABLE `sd_power`;
DROP TABLE `sd_resource`;
DROP TABLE `sd_role`;
DROP TABLE `sd_route`;
DROP TABLE `sd_test`;
DROP TABLE `sd_user`;
=======
/** 数据备份时间  2020-10-23 18:52:10 */
...
<<<<<<< HEAD
) ENGINE=InnoDB AUTO_INCREMENT=181 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='后台操作日志';
=======
) ENGINE=InnoDB AUTO_INCREMENT=275 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='后台操作日志'
>>>>>>> refs/remotes/origin/test
...
<<<<<<< HEAD
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='权限记录';
=======
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='资源表';
=======
  PRIMARY KEY (`id`),
...
CREATE TABLE `sd_role` (
  ...
  PRIMARY KEY (`id`) USING BTREE
<<<<<<< HEAD
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='角色';
=======
...
CREATE TABLE `sd_route` (
  ...
  PRIMARY KEY (`id`) USING BTREE
<<<<<<< HEAD
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='权限路由';
=======
...
CREATE TABLE `sd_test` (
  ...
  `update_time` datetime NOT NULL COMMENT '修改时间',
<<<<<<< HEAD
  `delete_time` int(1) NOT NULL DEFAULT '0' COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='测试表';
=======
  `delete_time` int(11) NOT NULL DEFAULT '0' COMMENT '删除时间',
  PRIMARY KEY (`id`)
...
INSERT INTO `sd_administrators` (`id`,`name`,`account`,`password`,`error_number`,`lately_time`,`error_date`,`role_id`,`status`,`create_time`,`update_time`,`delete_time`) VALUES ( 1, '超管', 'admin', '$2y$10$d/uL2UnR81Hw3ZuXv4WYS.1UXZv4YchW5mFrjcPk/En1Byjp3QHES', 0, '2020-10-20 22:07:15', '2020-07-09', 0, 1, '2020-10-20 22:07:15', '2020-10-20 22:07:15', 0);
...
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 154, 2, 0, 1, '{"table_name":"user","page_name":"","id":{"label":"ID","type":"","show_type":"text","join":""},"nickname":{"label":"昵称","type":"text","show_type":"text","join":""},"name":{"label":"姓名","type":"text","show_type":"text","join":""},"phone":{"label":"手机号","type":"text","show_type":"text","join":""},"avatar":{"label":"头像","type":"image","show_type":"image","join":""},"account":{"label":"账号","type":"text","show_type":"text","join":""},"id_card":{"label":"身份证号","type":"text","show_type":"text","join":""},"wx_openid":{"label":"微信openid","type":"images","show_type":"text","join":""},"invite_code":{"label":"邀请码","type":"editor","show_type":"text","join":""},"zfb_user_id":{"label":"支付宝user_id","type":"textarea","show_type":"text","join":""},"vip_level":{"label":"会员等级","type":"radio","show_type":"text","join":"{\"[0]\":\"1=好\",\"[1]\":\"2=不好\"}"},"balance":{"label":"余额，分","type":"text","show_type":"text","join":""},"integral":{"label":"积分","type":"text","show_type":"text","join":""},"email":{"label":"邮箱","type":"text","show_type":"text","join":""},"status":{"label":"状态","type":"radio","show_type":"text","join":"[\"1=正常\",\"2=封禁\",\"3=注..."},"create_time":{"label":"创建时间","type":"","show_type":"text","join":""},"update_time":{"label":"修改时间","type":"","show_type":"","join":""},"delete_time":{"label":"删除时间","type":"","show_type":"","join":""},"make":{"1":"2","2":"4","3":"8"}}', 'System.System/aux', '2020-08-05 00:24:30', '2020-08-05 00:24:30', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 155, 2, 0, 1, '{"title":"用户","route":"User\/index","type":"1","pid":"1","weigh":"1","icon":"","children":{"index":"on","create":"on","update":"on","del":"on"}}', 'System.Route/create', '2020-08-05 00:25:12', '2020-08-05 00:25:12', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 156, 2, 12, 1, '{"id":"3","name":"测试账号一","account":"123456","password_confirm":"","role_id":"2","status":"1"}', 'System.Administrators/update', '2020-08-05 00:34:13', '2020-08-05 00:34:13', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 157, 2, 0, 0, '{"account":"admin","captcha":"feba"}', 'System.Index/login', '2020-09-14 22:31:49', '2020-09-14 22:31:49', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 158, 2, 0, 1, '{"table_name":"user","page_name":"","id":{"label":"ID","type":"","show_type":"text","join":""},"nickname":{"label":"昵称","type":"text","show_type":"text","join":""},"name":{"label":"姓名","type":"text","show_type":"text","join":""},"phone":{"label":"手机号","type":"text","show_type":"text","join":""},"avatar":{"label":"头像","type":"image","show_type":"image","join":""},"account":{"label":"账号","type":"text","show_type":"text","join":""},"id_card":{"label":"身份证号","type":"text","show_type":"text","join":""},"wx_openid":{"label":"微信openid","type":"text","show_type":"text","join":""},"invite_code":{"label":"邀请码","type":"text","show_type":"text","join":""},"zfb_user_id":{"label":"支付宝user_id","type":"text","show_type":"text","join":""},"vip_level":{"label":"会员等级","type":"radio","show_type":"text","join":""},"balance":{"label":"余额，分","type":"text","show_type":"text","join":""},"integral":{"label":"积分","type":"text","show_type":"text","join":""},"email":{"label":"邮箱","type":"text","show_type":"text","join":""},"status":{"label":"状态","type":"radio","show_type":"text","join":"[\"1=正常\",\"2=封禁\",\"3=注..."},"create_time":{"label":"创建时间","type":"","show_type":"text","join":""},"update_time":{"label":"修改时间","type":"","show_type":"text","join":""},"delete_time":{"label":"删除时间","type":"","show_type":"text","join":""},"make":{"1":"2","2":"4","3":"8"}}', 'System.System/aux', '2020-09-14 22:33:51', '2020-09-14 22:33:51', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 159, 2, 0, 0, '{"account":"admin","captcha":"gvnj"}', 'System.Index/login', '2020-09-16 23:37:47', '2020-09-16 23:37:47', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 160, 2, 0, 0, '{"account":"admin","captcha":"rmgv"}', 'System.Index/login', '2020-09-16 23:37:56', '2020-09-16 23:37:56', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 161, 2, 0, 0, '{"account":"admin","captcha":"wc8p"}', 'System.Index/login', '2020-09-24 21:48:58', '2020-09-24 21:48:58', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 162, 2, 29, 1, '{"title":"","cover":"","file":"","show_images":"","intro":"","status":"1","administrators_id":"","pid":"","content":""}', 'Test/create', '2020-09-24 21:58:19', '2020-09-24 21:58:19', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 163, 2, 29, 1, '{"title":"","cover":"","file":"","show_images":"","intro":"","status":"1","administrators_id":"","pid":"","content":""}', 'Test/create', '2020-09-24 21:58:22', '2020-09-24 21:58:22', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 164, 2, 0, 0, '{"account":"admin","captcha":"e5qf"}', 'System.Index/login', '2020-09-26 23:23:51', '2020-09-26 23:23:51', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 165, 2, 0, 1, '{"id":"3","title":"测试一下图片","cover":"upload_resource\/20200506\/1aca...","file":"","show_images":"upload_resource\/20200506\/fd85...","intro":"你你你","status":"1","content":"<p>aS大萨达<\/p>"}', 'Test/edit', '2020-09-26 23:29:56', '2020-09-26 23:29:56', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 166, 2, 0, 1, '{"id":"3","title":"测试一下图片","cover":"upload_resource\/20200506\/1aca...","file":"","show_images":"upload_resource\/20200506\/fd85...","intro":"你你你","status":"1","content":"<p>aS大萨达<\/p>"}', 'Test/edit', '2020-09-26 23:30:05', '2020-09-26 23:30:05', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 167, 2, 0, 0, '{"account":"admin","captcha":"d32t"}', 'System.Index/login', '2020-09-27 18:46:04', '2020-09-27 18:46:04', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 168, 2, 0, 1, '{"id":"4","title":"asdsadasd","cover":"upload_resource\/20200507\/99e5...","file":"","show_images":"upload_resource\/20200507\/a698...","intro":"asdasdasd","status":"1","content":"<p>asdasd<\/p>"}', 'Test/update', '2020-09-27 18:57:33', '2020-09-27 18:57:33', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 169, 2, 0, 1, '{"id":"","title":"","cover":"","file":"","show_images":"","intro":"","content":""}', 'Test/update', '2020-09-27 20:36:32', '2020-09-27 20:36:32', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 170, 2, 0, 1, '{"id":"","title":"","cover":"","file":"","show_images":"","intro":"","content":""}', 'Test/update', '2020-09-27 20:37:08', '2020-09-27 20:37:08', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 171, 2, 0, 1, '{"id":"4","pid":"2","title":"asdsadasd","cover":"upload_resource\/20200507\/99e5...","file":"","administrators_id":"1","show_images":"upload_resource\/20200507\/a698...","intro":"asdasdasd","content":"<p>asdasd<\/p>"}', 'Test/update', '2020-09-27 21:51:20', '2020-09-27 21:51:20', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 172, 2, 0, 1, '{"id":"4","pid":"2","title":"asdsadasd","cover":"upload_resource\/20200507\/99e5...","file":"","administrators_id":"1","show_images":"upload_resource\/20200507\/a698...","intro":"asdasdasd","status":"1","content":"<p>asdasd<\/p>"}', 'Test/update', '2020-09-27 21:53:11', '2020-09-27 21:53:11', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 173, 2, 0, 1, '{"id":"4","pid":"2","title":"asdsadasd","cover":"upload_resource\/20200507\/99e5...","file":"","administrators_id":"1","show_images":"upload_resource\/20200507\/a698...","intro":"asdasdasd213123123213213","status":"1","content":"<p>asdasd<\/p>"}', 'Test/update', '2020-09-27 21:53:41', '2020-09-27 21:53:41', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 174, 2, 0, 1, '{"id":"4","pid":"2","title":"asdsadasd","cover":"upload_resource\/20200927\/d7f3...","file":"","administrators_id":"1","show_images":"upload_resource\/20200507\/a698...","intro":"asdasdasd213123123213213","status":"1","content":"<p>asdasd<\/p>"}', 'Test/update', '2020-09-27 22:19:53', '2020-09-27 22:19:53', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 175, 2, 0, 1, '{"id":"4","pid":"2","title":"asdsadasd","cover":"upload_resource\/20200927\/d7f3...","file":"","administrators_id":"1","show_images":"upload_resource\/20200507\/a698...","intro":"asdasdasd213123123213213","status":"1","content":"<p>asdasd<\/p>"}', 'Test/update', '2020-09-27 22:21:02', '2020-09-27 22:21:02', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 176, 2, 0, 0, '{"account":"admin","captcha":"mdhr"}', 'System.Index/login', '2020-09-29 22:04:19', '2020-09-29 22:04:19', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 177, 2, 0, 0, '{"account":"admin","captcha":"ujbq"}', 'System.Index/login', '2020-10-20 22:07:15', '2020-10-20 22:07:15', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 178, 2, 0, 1, '{"set":[],"role_id":"2"}', 'System.Power/set', '2020-10-20 22:12:38', '2020-10-20 22:12:38', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 179, 2, 0, 1, '{"set":[],"role_id":"2"}', 'System.Power/set', '2020-10-20 22:12:52', '2020-10-20 22:12:52', 0);
INSERT INTO `sd_log` (`id`,`method`,`route_id`,`administrators_id`,`param`,`route`,`create_time`,`update_time`,`delete_time`) VALUES ( 180, 2, 0, 1, '{"set":[],"role_id":"2"}', 'System.Power/set', '2020-10-20 22:12:58', '2020-10-20 22:12:58', 0);
-- sd_power 数据备份开始。



INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 1, 1, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 2, 3, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 3, 1, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 4, 3, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 5, 5, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 6, 1, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 7, 3, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 8, 15, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 9, 1, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 10, 3, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 11, 5, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 12, 1, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 13, 3, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 14, 5, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 15, 28, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 16, 1, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 17, 3, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 18, 5, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 19, 12, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 20, 28, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 21, 1, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 22, 3, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 23, 5, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 24, 12, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 25, 13, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 26, 28, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 1603203178);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 27, 1, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 0);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 28, 3, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 0);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 29, 5, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 0);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 30, 12, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 0);
INSERT INTO `sd_power` (`id`,`route_id`,`role_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 31, 28, 2, '2020-10-20 22:12:58', '2020-10-20 22:12:58', 0);
-- sd_resource 数据备份开始。
...
<<<<<<< HEAD
INSERT INTO `sd_resource` (`id`,`type`,`tag`,`pid`,`path`,`md5`,`create_time`,`update_time`,`delete_time`) VALUES ( 8, 2, '猪老板的家.jpg', 0, 'upload_resource/20200927/d7f339ccea33e54a677dcac5231a9e5d.jpg', 'b4db7cd044c6c2e8f362a69de70e40f8', '2020-09-27 22:16:09', '2020-09-27 22:16:09', 0);
-- sd_role 数据备份开始。
...
INSERT INTO `sd_role` (`id`,`role`,`pid`,`describe`,`administrators_id`,`create_time`,`update_time`,`delete_time`) VALUES ( 3, '测试角色2', 0, '嗯嗯你的', 1, '2020-06-18 15:02:17', '2020-06-18 15:02:17', 0);
-- sd_route 数据备份开始。
...
INSERT INTO `sd_route` (`id`,`title`,`route`,`pid`,`type`,`weigh`,`icon`,`create_time`,`update_time`,`delete_time`) VALUES ( 30, '用户', 'User/index', 1, 1, 1, '', '2020-08-05 00:25:12', '2020-08-05 00:25:12', 0);
INSERT INTO `sd_route` (`id`,`title`,`route`,`pid`,`type`,`weigh`,`icon`,`create_time`,`update_time`,`delete_time`) VALUES ( 31, '用户列表数据', 'User/index', 30, 2, 0, '', '2020-08-05 00:25:12', '2020-08-05 00:25:12', 0);
INSERT INTO `sd_route` (`id`,`title`,`route`,`pid`,`type`,`weigh`,`icon`,`create_time`,`update_time`,`delete_time`) VALUES ( 32, '新增用户', 'User/create', 30, 2, 1, '', '2020-08-05 00:25:12', '2020-08-05 00:25:12', 0);
INSERT INTO `sd_route` (`id`,`title`,`route`,`pid`,`type`,`weigh`,`icon`,`create_time`,`update_time`,`delete_time`) VALUES ( 33, '编辑用户', 'User/update', 30, 2, 2, '', '2020-08-05 00:25:12', '2020-08-05 00:25:12', 0);
INSERT INTO `sd_route` (`id`,`title`,`route`,`pid`,`type`,`weigh`,`icon`,`create_time`,`update_time`,`delete_time`) VALUES ( 34, '删除用户', 'User/del', 30, 2, 3, '', '2020-08-05 00:25:12', '2020-08-05 00:25:12', 0);
-- sd_test 数据备份开始。



INSERT INTO `sd_test` (`id`,`title`,`cover`,`show_images`,`intro`,`status`,`administrators_id`,`pid`,`content`,`create_time`,`update_time`,`delete_time`) VALUES ( 1, '你好你好', 'upload_resource/20200429/6fba04f2044bb0c5eb969003f95c5d93.jpg', 'upload_resource/20200429/7f82a960b6c217b6f8246ed3d20d9e3e.jpg,upload_resource/20200429/306d40a286538033d5d4f4e40e50f620.jpg,upload_resource/20200429/da68c56a9c4a7d68c6268c44258d6145.jpg', '年后冬奥会打算', 1, 1, 0, '<p>你好安神补脑对啊稍等<img src="http://192.168.5.11/sd-module/public//admin_resource/ueditor/image/20200429/1588162802249051.jpg" title="1588162802249051.jpg" alt="xub5zyafowl.jpg"/></p>', '2020-04-29 20:20:07', '2020-04-29 21:43:42', 1589859471);
...
INSERT INTO `sd_test` (`id`,`title`,`cover`,`show_images`,`intro`,`status`,`administrators_id`,`pid`,`content`,`create_time`,`update_time`,`delete_time`) VALUES ( 4, 'asdsadasd', 'upload_resource/20200927/d7f339ccea33e54a677dcac5231a9e5d.jpg', 'upload_resource/20200507/a698be506aa366e43641b638fcabb0ab.jpg,upload_resource/20200506/fd8551e0e6b688d07ad7f88fc852fb62.jpg,upload_resource/20200506/1aca73e97e2bff537df22b2046e02cd0.jpg,upload_resource/20200507/99e5b9ec17d81b488f2c560d33fe3cbe.jpg', 'asdasdasd213123123213213', 1, 1, 2, '<p>asdasd</p>', '2020-05-11 12:05:34', '2020-09-27 22:21:02', 0);
-- sd_user 数据备份开始。
