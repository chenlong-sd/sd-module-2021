...
class Resources
{
     ...
     */
    public function localhost(string $file_path)
    {
        $size = filesize($file_path);
        $mime = finfo_file(finfo_open(FILEINFO_MIME), $file_path);

        $this->output($mime, $size, $file_path);
    }
     ...
     */
    private function output(string $mime, int $size, string $url)
    {
